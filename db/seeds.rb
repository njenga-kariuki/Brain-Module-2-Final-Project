...
u1 = User.create(name: "Molly Nemerever", username: "Molly", city: "Seattle", email: "demo-user-2@example.com", professional_industry: "Software Engineering", about_me: "Hi! Looking to connect with other users.", password: "test", password_confirmation: "test")
u2 = User.create(name: "Njenga Kariuki", username: "Njenga", city: "Seattle", email: "demo-user-3@example.com", professional_industry: "Software Engineering", about_me: "Greetings! Hoping to learn from other professionals.", password: "test", password_confirmation: "test")
u3 = User.create(name: "Sally Staples", username: "Sally", city: "Portland", email: "demo-user-5@example.com", professional_industry: "Technology Consulting", about_me: "Looking to inspire others through technology.", password: "test", password_confirmation: "test")
u4 = User.create(name: "Sam Smith", username: "Sam", city: "New York", email: "demo-user-4@example.com", professional_industry: "Data Science", about_me: "Hope to broaden my professional development through this site.", password: "test", password_confirmation: "test")
u5 = User.create(name: "Alex Adams", username: "Alex", city: "Los Angeles", email: "demo-user-1@example.com", professional_industry: "Cyber Security", about_me: "I love to read and educate others about cyber security.", password: "test", password_confirmation: "test")
